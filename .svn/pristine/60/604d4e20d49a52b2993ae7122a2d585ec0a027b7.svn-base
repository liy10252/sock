...
public class AuditLogPage extends BasePage {
	...
	@FindBy(xpath = "//label[text()='功能：']/following-sibling::div/a[4]")
	private WebElement virusKill;

	@FindBy(xpath = "//label[text()='功能：']/following-sibling::div/a[5]")
	...
	@FindBy(xpath = "//div[text()='更新']/ancestor::tr/td[last()]/a")
	private WebElement del;

	@FindBy(xpath = "//span[text()='删除成功']")
	private WebElement delAlert;

	@FindBy(xpath = "//a[text()='日志删除']/ancestor::tr")
	private WebElement webDelData;
