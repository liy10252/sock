...
public class TimeFrameTest extends SeleniumTestCase {
	...
	public void thisWeek(){
		...
		historyPage.timeFrameTool(historyPage.getWeek());
		Assert.assertTrue(historyPage.getWebDataTr().findElement(By.xpath("./td[2]"))
	...
	public void thisMonth(){
		historyPage.timeFrameTool(historyPage.getMonth());
		Assert.assertTrue(historyPage.getWebDataTr().findElement(By.xpath("./td[2]"))
	...
	public void lastMonth(){
		historyPage.timeFrameTool(historyPage.getLastMonth());
		Assert.assertTrue(historyPage.getWebDataTr().findElement(By.xpath("./td[2]"))
