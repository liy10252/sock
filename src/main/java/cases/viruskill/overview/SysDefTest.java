...
public class SysDefTest extends SeleniumTestCase {
	...
	public void open(){
		...
		overViewPage.singleClick(overViewPage.getSysAll(),overViewPage.getSysOpen(),8);
		Assert.assertTrue(TestUtil.getValueList(overViewPage.getClientNames())
				...
				"已开启验证失败");
		Assert.assertTrue(overViewPage.checkItems(overViewPage.getWebSys(),
	...
	public void close(){
		...
		overViewPage.singleClick(overViewPage.getSysAll(),overViewPage.getSysClose());
